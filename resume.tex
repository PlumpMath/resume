...
\employer{Lockheed Martin}{August 2012---Present}{Software Engineer Asc.}
    \begin{achievements}
    \item Use JavaScript, CSS, C\#, and ASP.NET for development of dynamic database-backed web pages
    \item Optimize speed of web content delivery through testing, profiling, and experimentation
    \item Foster behavior-driven-development and implement framework to ensure project stability
    \item Propose and develop new features to enhance site usability and improve user experience
    \item Encourage and assist in adherence to coding standards to enhance project maintainability
    \item Provide scripts for automation of common repetitive tasks
    \end{achievements}
...
\project{Website}{http://cmaher.github.io}{}
\vspace{2pt}
